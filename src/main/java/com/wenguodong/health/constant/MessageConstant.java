...
public class MessageConstant {
    public static final String DATE_FORMAT_ERROR = "日期格式不对";
    ...
    public static final String SEND_VALIDATECODE_OUTTIME = "验证码已过时";
    ...
    public static final String DELECT_SETMEAL_SUCCESS = "删除套餐成功";
    public static final String DELECT_SETMEAL_FAIL = "删除套餐失败";
}
