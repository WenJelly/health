...
public class DateUtils {
     ...
     * 获取当前日期的本周一是几号
     *
     * @return 本周一的日期 "yyyy-MM-dd"
     */
    public static String getThisWeekMondayString() throws Exception {
        return DateUtils.parseDate2String(getThisWeekMonday());
    }
    ...
    // 获得本月第一天的日期
    public static String getFirstDay4ThisMonthString() throws Exception {
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.DAY_OF_MONTH, 1);
        return DateUtils.parseDate2String(getFirstDay4ThisMonth());
    }

    // 获得指定月份第一天的日期
    public static Date getFirstDay4Date(Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);

        // 2.通过Calendar对象得到本月第一天的日期
        calendar.set(Calendar.DAY_OF_MONTH, 1);
        return calendar.getTime();
    }

    // 获得指定月份的最后一天的日期
    public static Date getLastDay4Date(Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);

        // 3.通过Calendar对象得到本月最后一天的日期
        calendar.roll(Calendar.DAY_OF_MONTH, -1);
        return calendar.getTime();
    }

    public static Date getLastDay4Date(String dateStr, String pattern) throws ParseException {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("本月最后一天" + getLastDay4Date("2023.06", "yyyy.MM"));
            System.out.println("本月最后一天" + getLastDay4Date("2023.07", "yyyy.MM"));
            System.out.println("本月最后一天" + getLastDay4Date("2023.02", "yyyy.MM"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
